...
Like the angular angular equation, in general it is not possible to solve the radial~\eqref{eq3:teukolskyRadial} by known analytical methods.
...
The result~\eref{eq3:assymptoticR} is 
