...
$\Rightarrow$ Talk about the other two equations. 
...
\end{align}
Just like the spherical case, for each fixed $c$, $m$, $s$, will have an infinite set of eigenfunctions each with its corresponding eigenvalue. These eigenvalues are roots 
