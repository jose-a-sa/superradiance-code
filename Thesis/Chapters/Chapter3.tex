...
Up to sixth order, only the zero-order term depends on the sign of the spin weight, in agreement with \eqref{eq3:relationEVs} \cite{Fackerell1977,Seidel1989}.
