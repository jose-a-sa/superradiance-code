...
\begin{figure}[t]
	...
	\end{subfigure}
	\caption{Log plot of $\uu[\pm 1]{Z}{\ell m}$ as a function of $\bar{\omega}/m\bar{\omega}_H$ \cite{TeukolskyPress1973b}. Each color represents the same value of $\ell$, while different dashing corresponds to grouping the modes as $|\ell-m|=0,1,2$. Each element group with a similar order of magnitude.}
	\label{fig4:logZ}
\end{figure}
