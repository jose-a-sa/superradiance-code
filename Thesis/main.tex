...
\hypersetup{colorlinks,citecolor=green,urlcolor=blue,linkcolor=red} % Colors hyperlinks in blue - change to black if annoying
...
\thesistitle{Superradiant scattering at Kerr black holes} % Your thesis title \ttitle
