...
\begin{abstract}
	...
	We obtain the amplification/absorption factor for each multipole mode with high precision, obtaining a very good agreement with those found in the literature. Finally, we discuss the scattering of realistic electromagnetic waves by a Kerr BH, which are superpositions of these different modes.
\end{abstract}
