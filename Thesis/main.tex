...
\begin{abstract}[title={Resumo},degree={Mestre de Ciência},nameconnector={por}]
	...
	De seguida, introduzimos o formalismo de Newman-Pensore para estudar perturbações em espaço-tempo de Kerr, e obtemos o caso electromagético da equação mestre de Teukolsky.
