...
% HYPERREF
\usepackage[citecolor=green,urlcolor=blue,linkcolor=red,colorlinks]{hyperref}
...
\newcommand\BlueRibbon{
	...
	\fcolorbox{white}{fcupblue}{%
		\begin{minipage}[c][10mm][c]{3\spinew}
			\centering \bfseries \footnotesize \color{white}
			\tcnumber º \\ CICLO
		\end{minipage}
	}% RIBBON ENDS HERE
}}}
