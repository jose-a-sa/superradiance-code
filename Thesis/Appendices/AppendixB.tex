...
\end{align}
All relevant non-vanishing $\lambda$-symbols can be computed by coordinate derivatives on the one-form basis,
\begin{equation}
    \begin{alignedat}{3}
    ...
    \end{alignedat}
\end{equation}
All other necessary symbols may be found by the symmetry $\lambda_{abc}=-\lambda_{cba}$ or by complex conjugation ($3 \rightleftarrows 4$). For example, for computing the coefficient $\mu$, we need to use the relation $\lambda_{432}=-\lambda_{234}=-(\lambda_{234})^*$.
